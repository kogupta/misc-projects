...
public final class Main {
  ...
  private static final String[] files = {
      "10k_rows.txt", "100k_rows.txt", "200k_rows.txt",
      "400k_rows.txt", "800k_rows.txt", "1M_rows.txt",
      "10M_rows.txt", "itcont.txt"
  };
  ...
  public static void main(String... args) throws IOException {
    ...
    out.println("Press '0' once profiler is connected");
